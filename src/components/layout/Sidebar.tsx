...
const menuItems = [
  ...
  { href: '/backup', icon: Database, label: 'Data Backup' },
]
  ...
  const sidebarContent = (
    <>
      <div style={{ padding: '20px', borderBottom: '1px solid #334155', textAlign: 'center' }}>
        <img src='/logo.png' alt='ESHCO ELEMENTS' style={{ height: '80px', objectFit: 'contain', display: 'block', margin: '0 auto', filter: 'brightness(0) invert(1)' }} />
        <div style={{ fontSize: '12px', color: '#94a3b8', marginTop: '2px' }}>Inventory Management System</div>
      </div>
